...
$(function() {
    $(window).scroll(function() {
        ...
        let sec2_df_top = $('.about-text p:nth-child(1)').offset().top;

        let sec3_df_top = $('.about-text p:nth-child(3)').offset().top;
        let sec3_top = $("#intro_sec3 .skill_container ol").offset().top;

        let sec4_df_top = $("#intro_sec3 .skill_container ol").offset().top;
        ...
        if( scroll > sec2_top) {
            ...
            gsap.to(".about-text p:nth-child(3)", {duration: 0.7, stagger: 0.015, opacity: 1, y: 3, delay: 0.8})
        }
        // if( scroll > sec2_df_top) {
        //     gsap.to(".about-text p:nth-child(3)", {duration: 0.7, stagger: 0.015, opacity: 1, y: 3, delay: 0.8})
        // }
